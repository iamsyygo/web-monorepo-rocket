 ...
 * @returns {object} {[key: string]: string}
 */
function handleElementTheme(color) {
...
export { gradientMixColors, handleElementTheme, mixColor, withInstall, withInstallDirective, withInstallFunction, withNoopInstall };
