export declare const AoeTable: import("@aoe/utils").SFCWithInstall<import("vue").DefineComponent<{
    columns: {
        type: import("vue").PropType<import("./src/props").TableItems>;
        default: () => never[];
    };
    showOverflowTooltip: {
    ...
    border: boolean;
    columns: import("./src/props").TableItems;
