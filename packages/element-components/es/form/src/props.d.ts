 ...
 */
export type FormItemType = 'input' | 'select' | 'radio' | 'checkbox' | 'switch' | 'date' | 'time' | 'rate' | 'color' | 'slider' | 'upload' | 'cascader' | 'transfer' | 'inputNumber' | 'autocomplete' | 'checkboxButton' | 'radioButton' | 'option' | 'optionGroup' | 'button' | 'text' | 'form';
