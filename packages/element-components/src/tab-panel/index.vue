        ...
        <div class="tabs-content" :ref="setContentRef">
            ...
            >
                ...
                <div class="tabs-main" :title="tab.label">
                    <slot name="main" :tab="tab" :index="i">
                        <span class="tabs-favico" v-if="tab.icon">
                            <slot name="favico" :tab="tab" :index="i">
                                <el-icon :size="16"><symbol-icon :name="tab.icon"></symbol-icon></el-icon>
                            </slot>
                        </span>
                        <span
                            class="tabs-label"
                            :class="{ 'no-close': !showTabCloseIcon(tab), 'no-icon': !tab.favico }"
                        >
...
.tabs-wrapper {
    ...
    $--tab-height: 30px;
    $--tab-font-size: 14px;
    $--active-color: var(--el-color-primary, #409eff);
