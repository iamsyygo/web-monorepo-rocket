<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" class="illustration--not-found">
        <g id="freepik--background-complete--inject-118">
            ...
            <circle
                ...
                cy="415.38"
                r="7.35"
                transform="translate(-89.89 58.7) rotate(-13.28)"
                style="fill: #f0f0f0"
            ></circle>
            <path
        ...
        <g id="freepik--Planets--inject-118">
            <g style="opacity: 0.30000000000000004">
                <path d="M201,145.62a1.87,1.87,0,1,1-1.86-1.87A1.86,1.86,0,0,1,201,145.62Z" class="primary-fill"></path>
                <circle cx="72.97" cy="216.13" r="1.32" class="primary-fill"></circle>
                <circle cx="291.05" cy="408.33" r="1.89" class="primary-fill"></circle>
                <circle cx="336.5" cy="332" r="1.32" class="primary-fill"></circle>
                <path
                    d="M424.17,95.62a1.32,1.32,0,1,1-1.32-1.32A1.32,1.32,0,0,1,424.17,95.62Z"
                    class="primary-fill"
                ></path>
                <path d="M172.75,69a1.32,1.32,0,1,1-1.32-1.32A1.33,1.33,0,0,1,172.75,69Z" class="primary-fill"></path>
                <circle cx="277.7" cy="136.94" r="1.32" class="primary-fill"></circle>
            </g>
            <circle cx="141.23" cy="116.36" r="21.91" class="primary-fill"></circle>
        ...
        <g id="freepik--Astronaut--inject-118">
            <path
        ...
        <g id="freepik--Rocket--inject-118">
            <path
            ...
            <circle cx="222.2" cy="282.18" r="8.29" class="primary-fill"></circle>
            <polygon
