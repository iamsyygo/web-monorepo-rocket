    ...
    <div>
        <div>
            <div class="config-broder-tooltip--container">
                <div>
                    表格边框
                    <el-switch v-model="data.border" :active-value="true" :inactive-value="false"> </el-switch>
                </div>
                <div>
                    字段内容优化
                    <el-switch v-model="data.showOverflowTooltip" :active-value="true" :inactive-value="false">
                    </el-switch>
                </div>
                <div>
                    斑马纹
                    <el-switch v-model="data.stripe" :active-value="true" :inactive-value="false"> </el-switch>
                </div>
                <div>
                    高亮当前行
                    <el-switch v-model="data.highlightCurrentRow" :active-value="true" :inactive-value="false">
                    </el-switch>
                </div>
                <div>
                    排版
                    <el-radio-group v-model="data.size" size="small">
                        <el-radio-button v-for="item in layItems" :key="item.value" :label="item.value">{{
                            item.label
                        }}</el-radio-button>
                    </el-radio-group>
                </div>
        ...
        <div class="button-config-active">
            <el-button type="primary" size="small" @click="handleSubmit">确 认</el-button>
...
import { ElIcon, ElCheckbox, ElButton, ElSwitch, ElRadioGroup, ElRadioButton } from 'element-plus';
